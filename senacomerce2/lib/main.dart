...
import 'package:senacomerce/view2/pantallainicio.dart';
import 'package:senacomerce/view2/splash.dart';
...
void main() async {
  ...
  configLoading();
  runApp(const MaterialApp(home: PantallaInicio2(),debugShowCheckedModeBanner: false,));
}
